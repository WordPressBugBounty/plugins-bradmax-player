...
<div class="wrap">
	...
	<?php $bradmax_player_custom_player_info = self::get_customized_player_info(); ?>
	<?php $bradmax_player_modif_time = new \DateTime(); $bradmax_player_modif_time->setTimestamp($bradmax_player_custom_player_info['modification_ts']); ?>
	<h3>Customized player info</h3>

	<table class="form-table">
		<tr>
			<th scope="row"><label for="bradmax_player_file">Player version:</label></th>
			<td><?php echo esc_html($bradmax_player_custom_player_info['version']); ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="bradmax_player_file">Player skin:</label></th>
			<td><?php echo esc_html($bradmax_player_custom_player_info['skin']); ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="bradmax_player_file">File uploaded at:</label></th>
			<td><?php echo esc_html($bradmax_player_modif_time->format('Y-m-d H:i:s')); ?></td>
		</tr>
	</table>
